...
filename = 'e-ap16-iras11-158-p0'
filename2 = 'e-ap16-iras-158-p0'
filename3 = 'e-ap16-iras11-158.p0'
...
for run in run_region:
        ...
        # amplitude, lambda center, sigma [normalized flux units, angstrom, angstrom]
                ...
                NII_6583_amp = 7.47
                NII_6583_lamc = 6653.61
                NII_6583_sig = 1.5

                SII_6716_amp = 2
                SII_6716_lamc = 6787.63
                SII_6716_sig = 1.5
        ...
        # the region to exclude from the baseline fit - this region should cover emission lines and spurious features 
                ...
                OIII_4959_amp = 0.087
                OIII_4959_lamc = 5012.13
                OIII_4959_sig = 2

                OIII_5007_amp = 0.301
                OIII_5007_lamc = 5060.07
                OIII_5007_sig = 1.8
                ...
                OI_6300_amp = 0.323
                OI_6300_lamc = 6367.11
                OI_6300_sig = 1.8

                OI_6364_amp = 0.146
                OI_6364_lamc = 6432.47
                OI_6364_sig = 2
