...
filename = 'e-ap14-iras11-158-p0'
filename2 = 'e-ap14-iras-158-p0'
filename3 = 'e-ap14-iras11-158.p0'
...
for run in run_region:
        ...
        # amplitude, lambda center, sigma [normalized flux units, angstrom, angstrom]
                ...
                NII_6583_amp = 8.31
                NII_6583_lamc = 6653.4
                NII_6583_sig = 1.5

                SII_6716_amp = 2.55
                SII_6716_lamc = 6787.57
                SII_6716_sig = 1.5

                SII_6730_amp = 1.95
                SII_6730_lamc = 6802.29
                SII_6730_sig = 1.5
        ...
        # the region to exclude from the baseline fit - this region should cover emission lines and spurious features 
                ...
                OIII_4959_amp = 0.05
                OIII_4959_lamc = 5011.208
                OIII_4959_sig = 2

                OIII_5007_amp = 0.285
                OIII_5007_lamc = 5060.03
                OIII_5007_sig = 1.5
                ...
                OI_6300_amp = 0.4852
                OI_6300_lamc = 6367.116
                OI_6300_sig = 1.5

                OI_6364_amp = 0.204
                OI_6364_lamc = 6431.55
                OI_6364_sig = 1.5
