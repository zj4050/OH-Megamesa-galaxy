...
# amplitude, lambda center, sigma [normalized flux units, angstrom, angstrom]
        ...
        NII_6583_amp = 2.61
        NII_6583_lamc = 6647.8
        NII_6583_sig = 1.5

        SII_6716_amp = 0.85
        SII_6716_lamc = 6782.4
        SII_6716_sig = 1.5

        SII_6730_amp = 0.65
        SII_6730_lamc = 6797.2
        SII_6730_sig = 1.5
...
# the region to exclude from the baseline fit - this region should cover emission lines and spurious features 
        ...
        OIII_4959_amp = 0.037
        OIII_4959_lamc = 5008.7
        OIII_4959_sig = 1.5

        OIII_5007_amp = 0.17
        OIII_5007_lamc = 5055.3
        OIII_5007_sig = 1.5
