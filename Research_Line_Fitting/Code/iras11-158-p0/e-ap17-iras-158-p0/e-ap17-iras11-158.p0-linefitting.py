...
filename = 'e-ap17-iras11-158-p0'
filename2 = 'e-ap17-iras-158-p0'
filename3 = 'e-ap17-iras11-158.p0'
...
for run in run_region:
        ...
        # amplitude, lambda center, sigma [normalized flux units, angstrom, angstrom]
                ...
                NII_6548_amp = 13.193
                NII_6548_lamc = 6615.459
                NII_6548_sig = 1.5

                Halpha_amp = 24.81
                Halpha_lamc = 6633.314
                Halpha_sig = 1.5

                NII_6583_amp = 10.676
                NII_6583_lamc = 6653.66
                NII_6583_sig = 1.5

                SII_6716_amp = 2.56
                SII_6716_lamc = 6787.5
                SII_6716_sig = 1.5

                SII_6730_amp = 1.99
                SII_6730_lamc = 6802.6
                SII_6730_sig = 1.5
        ...
        # the region to exclude from the baseline fit - this region should cover emission lines and spurious features 
                ...
                OIII_4959_amp = 0.037
                OIII_4959_lamc = 5012.1
                OIII_4959_sig = 2

                OIII_5007_amp = 0.259
                OIII_5007_lamc = 5059.8
                OIII_5007_sig = 1.5
