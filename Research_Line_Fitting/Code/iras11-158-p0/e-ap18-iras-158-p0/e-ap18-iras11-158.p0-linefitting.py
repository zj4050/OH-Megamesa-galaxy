...
filename = 'e-ap18-iras11-158-p0'
filename2 = 'e-ap18-iras-158-p0'
filename3 = 'e-ap18-iras11-158.p0'
...
for run in run_region:
        ...
        # amplitude, lambda center, sigma [normalized flux units, angstrom, angstrom]
                ...
                NII_6583_amp = 2.91
                NII_6583_lamc = 6653.601
                NII_6583_sig = 1.5

                SII_6716_amp = 1.116
                SII_6716_lamc = 6787.614
                SII_6716_sig = 1.5

                SII_6730_amp = 0.873
                SII_6730_lamc = 6802.27
                SII_6730_sig = 1.5
        ...
        # the region to exclude from the baseline fit - this region should cover emission lines and spurious features 
                ...
                OIII_4959_amp = 0.083
                OIII_4959_lamc = 5011.18
                OIII_4959_sig = 2

                OIII_5007_amp = 0.306
                OIII_5007_lamc = 5060.05
                OIII_5007_sig = 1.8
                ...
                OI_6300_amp = 0.3664
                OI_6300_lamc = 6367.12
                OI_6300_sig = 1.5

                OI_6364_amp = 0.1685
                OI_6364_lamc = 6430.35
                OI_6364_sig = 1.5
