...
filename = 'e-ap19-iras11-158-p0'
filename2 = 'e-ap19-iras-158-p0'
filename3 = 'e-ap19-iras11-158.p0'
...
for run in run_region:
        ...
        # amplitude, lambda center, sigma [normalized flux units, angstrom, angstrom]
                ...
                NII_6548_amp = 0.817
                NII_6548_lamc = 6617.83
                NII_6548_sig = 1.5

                Halpha_amp = 3.61
                Halpha_lamc = 6632.129
                Halpha_sig = 1.5

                NII_6583_amp = 2.1917
                NII_6583_lamc = 6653.59
                NII_6583_sig = 1.5

                SII_6716_amp = 0.903
                SII_6716_lamc = 6787.612
                SII_6716_sig = 1.5

                SII_6730_amp = 0.679
                SII_6730_lamc = 6802.25
                SII_6730_sig = 1.5
        ...
        # the region to exclude from the baseline fit - this region should cover emission lines and spurious features 
                ...
                OIII_4959_amp = 0.015
                OIII_4959_lamc = 5005.78
                OIII_4959_sig = 2

                OIII_5007_amp = 0.21
                OIII_5007_lamc = 5059.22
                OIII_5007_sig = 1.5
                ...
                OI_6300_amp = 0.376
                OI_6300_lamc = 6367.15
                OI_6300_sig = 1.5

                OI_6364_amp = 0.152
                OI_6364_lamc = 6431.41
                OI_6364_sig = 2
