...
filename = 'e-ap12-iras11-158-p0'
filename2 = 'e-ap12-iras-158-p0'
filename3 = 'e-ap12-iras11-158.p0'
...
for run in run_region:
        ...
        # amplitude, lambda center, sigma [normalized flux units, angstrom, angstrom]
                ...
                NII_6583_amp = 4.01
                NII_6583_lamc = 6653.7
                NII_6583_sig = 1.5

                SII_6716_amp = 1.246
                SII_6716_lamc = 6787.61
                SII_6716_sig = 1.5
        ...
        # the region to exclude from the baseline fit - this region should cover emission lines and spurious features 
                ...
                OIII_4959_amp = 0.043
                OIII_4959_lamc = 5010.38
                OIII_4959_sig = 2

                OIII_5007_amp = 0.253
                OIII_5007_lamc = 5060.06
                OIII_5007_sig = 1.5
                ...
                OI_6300_amp = 0.369
                OI_6300_lamc = 6367.13
                OI_6300_sig = 1.5

                OI_6364_amp = 0.15
                OI_6364_lamc = 6431.44
                OI_6364_sig = 2
