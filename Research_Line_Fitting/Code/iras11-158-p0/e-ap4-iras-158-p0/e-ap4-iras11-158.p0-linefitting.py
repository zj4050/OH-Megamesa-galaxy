...
filename = 'e-ap4-iras11-158-p0'

spectrum1 = '/Users/kamiori/Desktop/Python/Research Project/OH Megamesa/Research_Line_Fitting/Output/iras11-PA158/e-ap' + filename[4] + '-iras-158-p0/' + filename + '_fit_without_spurious_lines.txt' #mac_mini directory

spectrum2 = '/Users/kamiori/Desktop/Python/Research Project/OH Megamesa/Research_Line_Fitting/Output/iras11-PA158/e-ap' + filename[4]+ '-iras-158-p0/' + filename + '_PPXFfit.txt'
#spectrum = '/Users/kamiori/Desktop/Python/line_fitting/pa253_nuclear_ppxf.dat' #laptop directory


output_directory = '/Users/kamiori/Desktop/Python/Research Project/OH Megamesa/Research_Line_Fitting/Output/iras11-PA158/e-ap' + filename[4] + '-iras-158-p0/' #mac_mini_directory
...
# amplitude, lambda center, sigma [normalized flux units, angstrom, angstrom]
        ...
        NII_6583_amp = 10.27
        NII_6583_lamc = 6647.6
        NII_6583_sig = 1.5

        SII_6716_amp = 3.2
        SII_6716_lamc = 6781.6
        SII_6716_sig = 1.5

        SII_6730_amp = 2.56
        SII_6730_lamc = 6796.6
        SII_6730_sig = 1.5
...
# the region to exclude from the baseline fit - this region should cover emission lines and spurious features 
        ...
        OIII_4959_amp = 0.06
        OIII_4959_lamc = 5007.6
        OIII_4959_sig = 1.5

        OIII_5007_amp = 0.4
        OIII_5007_lamc = 5055.4
        OIII_5007_sig = 1.5
