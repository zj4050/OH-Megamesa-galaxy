...
for run in run_region:
        ...
        # amplitude, lambda center, sigma [normalized flux units, angstrom, angstrom]
                ...
                NII_6548_amp = 0.924
                NII_6548_lamc = 6616.716
                NII_6548_sig = 1.5

                Halpha_amp = 4.02
                Halpha_lamc = 6632.039
                Halpha_sig = 1.5

                NII_6583_amp = 2.652
                NII_6583_lamc = 6652.89
                NII_6583_sig = 1.5

                SII_6716_amp = 0.585
                SII_6716_lamc = 6781.24
                SII_6716_sig = 1.5

                SII_6730_amp = 0.469
                SII_6730_lamc = 6801.86
                SII_6730_sig = 1.5
        ...
        # the region to exclude from the baseline fit - this region should cover emission lines and spurious features 
                ...
                OIII_4959_amp = 0.103
                OIII_4959_lamc = 5008.73
                OIII_4959_sig = 2

                OIII_5007_amp = 0.245
                OIII_5007_lamc = 5059.5
                OIII_5007_sig = 1.8
                ...
                OI_6300_amp = 0.784
                OI_6300_lamc = 6365.77
                OI_6300_sig = 1.5

                OI_6364_amp = 0.207
                OI_6364_lamc = 6430.25
                OI_6364_sig = 2
