...
for run in run_region:
        ...
        # amplitude, lambda center, sigma [normalized flux units, angstrom, angstrom]
                ...
                NII_6583_amp = 2.223
                NII_6583_lamc = 6651.79
                NII_6583_sig = 1.5

                SII_6716_amp = 0.557
                SII_6716_lamc = 6786.13
                SII_6716_sig = 1.5

                SII_6730_amp = 0.367
                SII_6730_lamc = 6799.61
                SII_6730_sig = 1.5
        ...
        # the region to exclude from the baseline fit - this region should cover emission lines and spurious features 
                ...
                OIII_4959_amp = 0.158
                OIII_4959_lamc = 5005.45
                OIII_4959_sig = 1.8

                OIII_5007_amp = 0.016
                OIII_5007_lamc = 5059.52
                OIII_5007_sig = 1.8
                ...
                OI_6300_amp = 3.993
                OI_6300_lamc = 6365.76
                OI_6300_sig = 1.5

                OI_6364_amp = 0.036
                OI_6364_lamc = 6432.39
                OI_6364_sig = 2
