import sys
import os 
index = os.path.basename(__file__)[0:11]
...
for run in run_region:
        ...
        # amplitude, lambda center, sigma [normalized flux units, angstrom, angstrom]
                ...
                NII_6548_amp = 1.863
                NII_6548_lamc = 6615.62
                NII_6548_sig = 1.5

                Halpha_amp = 11.522
                Halpha_lamc = 6630.938
                Halpha_sig = 1.5

                NII_6583_amp = 5.737
                NII_6583_lamc = 6651.78
                NII_6583_sig = 1.5

                SII_6716_amp = 1.523
                SII_6716_lamc = 6786.1
                SII_6716_sig = 1.5

                SII_6730_amp = 1.105
                SII_6730_lamc = 6800.65
                SII_6730_sig = 1.5
        ...
        # the region to exclude from the baseline fit - this region should cover emission lines and spurious features 
                ...
                OIII_4959_amp = 0.234
                OIII_4959_lamc = 5010.8
                OIII_4959_sig = 1.8

                OIII_5007_amp = 0.183
                OIII_5007_lamc = 5059.511
                OIII_5007_sig = 1.8
                ...
                OI_6300_amp = 2.206
                OI_6300_lamc = 6365.67
                OI_6300_sig = 1.5

                OI_6364_amp = 0.18
                OI_6364_lamc = 6430.67
                OI_6364_sig = 2
