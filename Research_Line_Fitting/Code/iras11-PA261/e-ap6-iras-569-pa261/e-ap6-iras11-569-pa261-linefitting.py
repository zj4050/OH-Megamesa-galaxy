...
for run in run_region:
        ...
        # amplitude, lambda center, sigma [normalized flux units, angstrom, angstrom]
                ...
                NII_6583_amp = 4.054
                NII_6583_lamc = 6655.08
                NII_6583_sig = 1.5

                SII_6716_amp = 1.053
                SII_6716_lamc = 6789.44
                SII_6716_sig = 1.5

                SII_6730_amp = 0.742
                SII_6730_lamc = 6804.09
                SII_6730_sig = 1.5
        ...
        # the region to exclude from the baseline fit - this region should cover emission lines and spurious features 
                ...
                OIII_4959_amp = 0.101
                OIII_4959_lamc = 5011.4
                OIII_4959_sig = 2

                OIII_5007_amp = 0.478
                OIII_5007_lamc = 5060.81
                OIII_5007_sig = 1.8
                ...
                OI_6300_amp = 1.543
                OI_6300_lamc = 6364.73
                OI_6300_sig = 1.5

                OI_6364_amp = 0.107
                OI_6364_lamc = 6432.33
                OI_6364_sig = 2
