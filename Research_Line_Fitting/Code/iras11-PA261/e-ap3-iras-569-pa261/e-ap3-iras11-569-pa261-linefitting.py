import sys
import os 
index = os.path.basename(__file__)[0:10]

filename2 = index + '-569-pa261'
filename  = index  + '11-569-pa261'
filename3 = filename 

#/Users/kamiori/Desktop/Research Project/OH Megamesa galaxy/Research_Line_Fitting/Code/iras11-PA261/e-ap1-iras-569-pa261/e-ap1-iras11-569-pa261-linefitting.py
if __file__ == '/Users/kamiori/Desktop/Research Project/OH Megamesa galaxy/Research_Line_Fitting/Code/iras11-PA261/{:s}/{:s}-linefitting.py'\
                .format(filename2, filename3):
        spectrum1 = '/Users/kamiori/Desktop/Research Project/OH Megamesa galaxy/Research_Line_Fitting/Output/iras11-PA261/{:s}/{:s}_fit_without_spurious_lines.txt'\
                        .format(filename, filename) 
        spectrum2 = '/Users/kamiori/Desktop/Research Project/OH Megamesa galaxy/Research_Line_Fitting/Output/iras11-PA261/{:s}/{:s}_PPXFfit.txt'\
                        .format(filename, filename)
        output_directory = '/Users/kamiori/Desktop/Research Project/OH Megamesa galaxy/Research_Line_Fitting/Output/iras11-PA261/{:s}/'.format(filename)
...
elif __file__ == '/Users/kamiori/Desktop/OH-Megamesa-galaxy/Research_Line_Fitting/Code/iras11-PA261/{:s}/{:s}-linefitting.py'.format(filename2, filename3):
        spectrum1 = '/Users/kamiori/Desktop/OH-Megamesa-galaxy/Research_Line_Fitting/Output/iras11-PA261/{:s}/{:s}_fit_without_spurious_lines.txt'.format(filename, filename)
        spectrum2 = '/Users/kamiori/Desktop/OH-Megamesa-galaxy/Research_Line_Fitting/Output/iras11-PA261/{:s}/{:s}_PPXFfit.txt'.format(filename, filename)
        output_directory = '/Users/kamiori/Desktop/OH-Megamesa-galaxy/Research_Line_Fitting/Output/iras11-PA261/{:s}/'.format(filename)
...
for run in run_region:
        ...
        # amplitude, lambda center, sigma [normalized flux units, angstrom, angstrom]
                ...
                NII_6583_amp = 4.271
                NII_6583_lamc = 6655.089
                NII_6583_sig = 1.5

                SII_6716_amp = 1.076
                SII_6716_lamc = 6789.46
                SII_6716_sig = 1.5

                SII_6730_amp = 0.813
                SII_6730_lamc = 6804.06
                SII_6730_sig = 1.5
        ...
        # the region to exclude from the baseline fit - this region should cover emission lines and spurious features 
                ...
                OIII_4959_amp = 0.0936
                OIII_4959_lamc = 5011.25
                OIII_4959_sig = 2

                OIII_5007_amp = 0.235
                OIII_5007_lamc = 5061.14
                OIII_5007_sig = 1.8
                ...
                OI_6300_amp = 0.962
                OI_6300_lamc = 6365.73
                OI_6300_sig = 1.5

                OI_6364_amp = 0.192
                OI_6364_lamc = 6433.442
                OI_6364_sig = 1.8
