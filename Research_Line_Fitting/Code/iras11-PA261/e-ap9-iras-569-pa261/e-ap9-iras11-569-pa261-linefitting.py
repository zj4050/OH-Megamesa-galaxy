...
for run in run_region:
        ...
        # amplitude, lambda center, sigma [normalized flux units, angstrom, angstrom]
                ...
                NII_6548_amp = 0.927
                NII_6548_lamc = 6616.72
                NII_6548_sig = 1.5

                Halpha_amp = 4.073
                Halpha_lamc = 6632.036
                Halpha_sig = 1.5

                NII_6583_amp = 2.69
                NII_6583_lamc = 6652.9
                NII_6583_sig = 1.5

                SII_6716_amp = 0.576
                SII_6716_lamc = 6787.22
                SII_6716_sig = 1.5

                SII_6730_amp = 0.465
                SII_6730_lamc = 6801.87
                SII_6730_sig = 1.5
        ...
        # the region to exclude from the baseline fit - this region should cover emission lines and spurious features 
                ...
                OIII_4959_amp = 0.103
                OIII_4959_lamc = 5010.89
                OIII_4959_sig = 2

                OIII_5007_amp = 0.251
                OIII_5007_lamc = 5059.501
                OIII_5007_sig = 1.8
