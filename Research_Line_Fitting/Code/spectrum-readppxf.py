...
#specfile = '/Users/kamiori/Desktop/Python/Research Project/OH Megamesa/Research_Line_Fitting/OHMG-IRAS11506-longslit-spectra/iras11-PA158/e-ap0-iras11-158-p0.fits'
#output_directory = '/Users/kamiori/Desktop/Python/Research Project/OH Megamesa/Research_Line_Fitting/Output/e-ap0-iras-158-p0/'
#output_file = 'iras11-158-p0' 
...
for i in range(2,15):
    specfile = '/Users/kamiori/Desktop/Python/Research Project/OH Megamesa/Research_Line_Fitting/OHMG-IRAS11506-longslit-spectra/iras11-PA261/e-ap{:s}-iras11-569-pa261.fits'.format(str(i))
    output_directory = '/Users/kamiori/Desktop/Python/Research Project/OH Megamesa/Research_Line_Fitting/Output/iras11-PA261/e-ap{:s}-iras11-569-pa261/'.format(str(i))
    output_file = 'e-ap{:s}-iras11-569-pa261'.format(str(i))
