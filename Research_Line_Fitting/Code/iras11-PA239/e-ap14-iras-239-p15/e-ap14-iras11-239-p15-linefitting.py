...
for run in run_region:
        ...
        # amplitude, lambda center, sigma [normalized flux units, angstrom, angstrom]
                ...
                NII_6548_amp = 2.049
                NII_6548_lamc = 6610.503
                NII_6548_sig = 1.5

                Halpha_amp = 13.643
                Halpha_lamc = 6624.759
                Halpha_sig = 1.5

                NII_6583_amp = 6.62
                NII_6583_lamc = 6646.202
                NII_6583_sig = 1.5

                SII_6716_amp = 2.077
                SII_6716_lamc = 6779.91
                SII_6716_sig = 1.5

                SII_6730_amp = 1.549
                SII_6730_lamc = 6794.57
                SII_6730_sig = 1.5
        ...
        # the region to exclude from the baseline fit - this region should cover emission lines and spurious features 
                ...
                OI_6300_amp = 0.689
                OI_6300_lamc = 6360.27
                OI_6300_sig = 1.5

                OI_6364_amp = 0.154
                OI_6364_lamc = 6424.54
                OI_6364_sig = 1.8
