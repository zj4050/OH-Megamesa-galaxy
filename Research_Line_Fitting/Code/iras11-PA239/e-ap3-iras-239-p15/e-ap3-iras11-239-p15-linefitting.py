...
for run in run_region:
        ...
        # amplitude, lambda center, sigma [normalized flux units, angstrom, angstrom]
                ...
                NII_6548_amp = 2.104
                NII_6548_lamc = 6611.7
                NII_6548_sig = 1.5

                Halpha_amp = 14.624
                Halpha_lamc = 6625.949
                Halpha_sig = 1.5

                NII_6583_amp = 6.609
                NII_6583_lamc = 6647.391
                NII_6583_sig = 1.5

                SII_6716_amp = 1.634
                SII_6716_lamc = 6781.76
                SII_6716_sig = 1.5

                SII_6730_amp = 1.406
                SII_6730_lamc = 6795.81
                SII_6730_sig = 1.5
        ...
        # the region to exclude from the baseline fit - this region should cover emission lines and spurious features 
                ...
                OIII_4959_amp = 0.045
                OIII_4959_lamc = 5008.22
                OIII_4959_sig = 2

                OIII_5007_amp = 0.216
                OIII_5007_lamc = 5054.85
                OIII_5007_sig = 1.8
                ...
                OI_6300_amp = 0.476
                OI_6300_lamc = 6360.25
                OI_6300_sig = 1.5

                OI_6364_amp = 0.18
                OI_6364_lamc = 6426.86
                OI_6364_sig = 2
