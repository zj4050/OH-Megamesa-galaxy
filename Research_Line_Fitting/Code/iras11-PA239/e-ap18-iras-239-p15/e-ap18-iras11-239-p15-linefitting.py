...
filename2 = index + '-239-p15'
filename  = index  + '11-239-p15'
filename3 = filename 


if __file__ == '/Users/kamiori/Desktop/Research Project/OH Megamesa galaxy/Research_Line_Fitting/Code/iras11-PA239/{:s}/{:s}-linefitting.py'\
                .format(filename2, filename3):
        spectrum1 = '/Users/kamiori/Desktop/Research Project/OH Megamesa galaxy/Research_Line_Fitting/Output/iras11-PA239/{:s}/{:s}_fit_without_spurious_lines.txt'\
                        .format(filename, filename) 
        spectrum2 = '/Users/kamiori/Desktop/Research Project/OH Megamesa galaxy/Research_Line_Fitting/Output/iras11-PA239/{:s}/{:s}_PPXFfit.txt'\
                        .format(filename, filename)
        output_directory = '/Users/kamiori/Desktop/Research Project/OH Megamesa galaxy/Research_Line_Fitting/Output/iras11-PA239/{:s}/'.format(filename)
...
elif __file__ == '/Users/kamiori/Desktop/OH-Megamesa-galaxy/Research_Line_Fitting/Code/iras11-PA239/{:s}/{:s}-linefitting.py'.format(filename2, filename3):
        spectrum1 = '/Users/kamiori/Desktop/OH-Megamesa-galaxy/Research_Line_Fitting/Output/iras11-PA239/{:s}/{:s}_fit_without_spurious_lines.txt'.format(filename, filename)
        spectrum2 = '/Users/kamiori/Desktop/OH-Megamesa-galaxy/Research_Line_Fitting/Output/iras11-PA239/{:s}/{:s}_PPXFfit.txt'.format(filename, filename)
        output_directory = '/Users/kamiori/Desktop/OH-Megamesa-galaxy/Research_Line_Fitting/Output/iras11-PA239/{:s}/'.format(filename)
...
for run in run_region:
        ...
        # amplitude, lambda center, sigma [normalized flux units, angstrom, angstrom]
                ...
                NII_6548_amp = 0.712
                NII_6548_lamc = 6611.04
                NII_6548_sig = 1.5

                Halpha_amp = 3.992
                Halpha_lamc = 6625.951
                Halpha_sig = 1.5

                NII_6583_amp = 2.392
                NII_6583_lamc = 6646.2
                NII_6583_sig = 1.5

                SII_6716_amp = 0.883
                SII_6716_lamc = 6781.11
                SII_6716_sig = 1.5

                SII_6730_amp = 0.631
                SII_6730_lamc = 6795.25
                SII_6730_sig = 1.5
        ...
        # the region to exclude from the baseline fit - this region should cover emission lines and spurious features 
                ...
                OIII_4959_amp = 0.0619
                OIII_4959_lamc = 5006.95
                OIII_4959_sig = 2

                OIII_5007_amp = 0.309
                OIII_5007_lamc = 5054.81
                OIII_5007_sig = 1.8
                ...
                OI_6300_amp = 0.85
                OI_6300_lamc = 6359.15
                OI_6300_sig = 1.5

                OI_6364_amp = 0.196
                OI_6364_lamc = 6432.53
                OI_6364_sig = 2
