...
for run in run_region:
        ...
        # amplitude, lambda center, sigma [normalized flux units, angstrom, angstrom]
                ...
                NII_6548_amp = 3.108
                NII_6548_lamc = 6611.69
                NII_6548_sig = 1.5

                Halpha_amp = 23.069
                Halpha_lamc = 6627.137
                Halpha_sig = 1.5

                NII_6583_amp = 10.035
                NII_6583_lamc = 6647.389
                NII_6583_sig = 1.5

                SII_6716_amp = 2.829
                SII_6716_lamc = 6782.34
                SII_6716_sig = 1.5

                SII_6730_amp = 2.193
                SII_6730_lamc = 6796.48
                SII_6730_sig = 1.5
        ...
        # the region to exclude from the baseline fit - this region should cover emission lines and spurious features 
                ...
                OIII_4959_amp = 0.107
                OIII_4959_lamc = 5007.01
                OIII_4959_sig = 2

                OIII_5007_amp = 0.401
                OIII_5007_lamc = 5054.48
                OIII_5007_sig = 1.8
